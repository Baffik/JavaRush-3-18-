...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        Cat ded = new Cat(grandPA);

        String grandma = reader.readLine();
        Cat babul = new Cat(grandma);

        String fatherName = reader.readLine();
        Cat catFather = new Cat(fatherName, ded, null);

        String motherName = reader.readLine();
        Cat catMother = new Cat(motherName, null, babul );
        ...
        Cat(String name, Cat parent)
    {
        ...
        public String toString()
        {
            ...
            return "Cat name is " + name + ", mother is " + parent2.name + ", father is " + parent.name;
        }
    }
